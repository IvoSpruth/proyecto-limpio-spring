...
<div class="w3-container">
  ...
  <div class="w3-row">
    ...
    <div class="w3-half w3-panel w3-pale-green w3-leftbar w3-border-green">
      <div class="w3-container">
        <p><span class="w3-large">Total: </span><f:formatNumber type="number" value="${envio.venta.total}"
  ...
  <div class="w3-row">
    ...
    <div class="w3-half w3-panel w3-pale-green w3-leftbar w3-border-green">
      ...
      <p><span class="w3-large">Estado actual del envío:</span> ${envio.estadoEnvio.name()}</p>
      <p><span class="w3-large">Fecha de salida:</span> ${envio.fechaSalida.toString()}</p>
      <p><span class="w3-large">Fecha de llegada aprox.: </span>${envio.fechaLlegada.toString()}</p>
    </div>
  </div>
</div>

<div class="w3-container">
  <a href="${pagePath}/goVentaForm" class="w3-button w3-green w3-margin-right">Añadir venta</a>
  <a href="${pagePath}/envios/mostrar" class="w3-button w3-green">Mostrar envios</a>
</div>
</div>
